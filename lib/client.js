...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    var CSS = [
      ...
      '  /* Settings panel (has a <nav> child) -> full-screen, stacked, scrollable. */',
      '  [role="dialog"]:has(> nav){width:100vw !important;height:100dvh !important;max-width:none !important;border-radius:0 !important;flex-direction:column !important;}',
      '  /* nav rail becomes a horizontal scroller above the content. */',
      '  [role="dialog"]:has(> nav) > nav{flex:none !important;flex-direction:row !important;gap:8px !important;width:auto !important;max-width:100vw;overflow-x:auto;padding:10px 12px;-webkit-overflow-scrolling:touch;}',
      '  [role="dialog"]:has(> nav) > nav > div{white-space:nowrap;flex:none;}',
      '  /* small modal primitive (create-workspace etc): nudge off edge */',
      '  [role="dialog"]:not(:has(> nav)){width:100% !important;border-radius:16px !important;}',
