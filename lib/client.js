...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var inject = [] // no services injected; all work happens in apply
    ...
    function apply(ctx) {
      ...
      var tagId = 'dsh-responsive/client'
      if (typeof document !== 'undefined' && document.querySelector('style[data-plugin-css="dsh-responsive/client"]') === null) {
        var tag = document.createElement('style')
        tag.dataset.plugin = 'dsh-responsive'
